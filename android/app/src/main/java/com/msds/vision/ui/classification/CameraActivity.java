...
package com.msds.vision.ui.classification;
...
import com.msds.vision.ui.classification.env.ImageUtils;
import com.msds.vision.ui.classification.env.Logger;
...
public abstract class CameraActivity extends Fragment
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    return inflater.inflate(R.layout.tfe_ic_activity_camera, null, false);
  }
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    //view.setContentView(R.layout.tfe_ic_activity_camera);
    ...
    recognitionTextView = view.findViewById(R.id.detected_item);
    recognitionValueTextView = view.findViewById(R.id.detected_item_value);
    recognition1TextView = view.findViewById(R.id.detected_item1);
    recognition1ValueTextView = view.findViewById(R.id.detected_item1_value);
    recognition2TextView = view.findViewById(R.id.detected_item2);
    recognition2ValueTextView = view.findViewById(R.id.detected_item2_value);

    frameValueTextView = view.findViewById(R.id.frame_info);
    cropValueTextView = view.findViewById(R.id.crop_info);
    cameraResolutionTextView = view.findViewById(R.id.view_info);
    rotationTextView = view.findViewById(R.id.rotation_info);
  ...
  protected void setFragment() {
    ...
    getActivity().getSupportFragmentManager().beginTransaction().add(R.id.container, camera2Fragment).commit();
  }
